      ...
      <div class="login-wrapper my-auto">
        ...
        <form method="POST">
          ...
          <div class="form-group mb-5">
            <label for="email">Ingrese contraseña nueva:</label>
            <input type="password" name="password" id="password" class="form-control" placeholder="xxxx">
          </div>
          <input type="submit" id="login" class="btn btn-block login-btn" value="Guardar">
        </form>
        <a href="<?php echo $_ENV['URL_BASE']; ?>/" class="forgot-password-link">Cancelar</a>
      </div>
    </div>
